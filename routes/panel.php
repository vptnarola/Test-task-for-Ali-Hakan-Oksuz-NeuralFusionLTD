...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => [ 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath' ]], function() {
    Route::prefix('dashboard')->middleware('auth')->name('dashboard.')->group(function () {
        ...
        Route::prefix('adsense')->name('adsense.')->group(function () {
            ...
            Route::get('/add-or-update/{id?}', [AdsenseController::class, 'adsenseAddOrUpdate'])->name('addOrUpdate');
            Route::get('/delete/{id?}', [AdsenseController::class, 'adsenseDelete'])->name('delete');
            Route::post('/save', [AdsenseController::class, 'adsenseAddOrUpdateSave']);
        });
