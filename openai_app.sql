...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 23, 2024 at 01:51 PM
...
CREATE TABLE IF NOT EXISTS `adsenses` (
  ...
  `banner_width` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `banner_height` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `banner_image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 - deactivate, 1 - activate',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `adsenses` (`id`, `name`, `slug`, `banner_width`, `banner_height`, `banner_image`, `url`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Landing Features Section', 'landing-features-section', '728', '90', 'dQvB-landing-features-section-image.jpg', 'https://groupabdu.com/', 1, '2024-02-23 05:05:02', '2024-02-23 05:49:11'),
(2, 'Landing Header Section', 'landing-header-section', '0', '0', 'cbkh-landing-header-section-image.jpg', 'https://order.allcoating.se/', 0, '2024-02-23 06:12:58', '2024-02-23 06:14:37');
...
(1, 'Limited Offer', 'Sign up and receive 20% bonus discount on checkout.', 'Unleash the Power of AI', 'Ultimate AI', 'All-in-one platform to generate AI content and start making money in minutes.', 'Discover MagicAI', 'Start Making Money', NULL, 'Start your free trial.', 'Pay once, own forever.', 'Unlock your business potential by letting the AI work and generate money for you.', 'Join our community', 'https://codecanyon.net/item/magicai-openai-content-text-image-chat-code-generator-as-saas/45408109', '2023 MagicAI. All images are for demo purposes.', '2023-06-30 19:13:33', '2023-06-30 19:13:33', 'Generator,Chatbot,Assistant', 'Sign In', 'Join Hub');
...
(2, 'Payment Gateways', 'Securely process credit card or other electronic payment methods.', 'upload/images/frontent/tools/WTaf-payment-gateways.png', '2023-05-29 11:19:49', '2023-05-29 11:19:49'),
...
(79, '2023_06_23_141415_create_webhookhistory_table', 1),
(81, '2024_02_22_072208_create_adsenses_table', 2);
...
(40, 'AI Speech to Text', 'Accurately convert voice into text.', 'ai_speech_to_text', 1, '[{\"name\":\"file\",\"type\":\"file\",\"question\":\"Upload an Audio File (mp3, mp4, mpeg, mpga, m4a, wav, and webm)(Max: 25Mb)\",\"select\":\"\"}]', '<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"48\" viewBox=\"0 96 960 960\" width=\"48\"><path d=\"M140 976q-24.75 0-42.375-17.625T80 916V236q0-24.75 17.625-42.375T140 176h380l-60 60H140v680h480V776h60v140q0 24.75-17.625 42.375T620 976H140Zm100-170v-60h280v60H240Zm0-120v-60h200v60H240Zm380 10L460 536H320V336h140l160-160v520Zm60-92V258q56 21 88 74t32 104q0 51-35 101t-85 67Zm0 142v-62q70-25 125-90t55-158q0-93-55-158t-125-90v-62q102 27 171 112.5T920 436q0 112-69 197.5T680 746Z\"/></svg>', 0, 'audio', '2023-04-08 16:30:04', '2023-05-09 12:38:40', NULL, 0, 0, '#DEFF81', 'blog'),
...
(44, 'AI Voiceover', 'The AI app that turns audio speech into text with ease. Get ready to generate custom texts from audio files quickly and accurately.', 'ai_voiceover', 1, '[{\"name\":\"file\",\"type\":\"file\",\"question\":\"Upload an Audio File (mp3, mp4, mpeg, mpga, m4a, wav, and webm)(Max: 25Mb)\",\"select\":\"\"}]', '<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"48\" viewBox=\"0 96 960 960\" width=\"48\"><path d=\"M140 976q-24.75 0-42.375-17.625T80 916V236q0-24.75 17.625-42.375T140 176h380l-60 60H140v680h480V776h60v140q0 24.75-17.625 42.375T620 976H140Zm100-170v-60h280v60H240Zm0-120v-60h200v60H240Zm380 10L460 536H320V336h140l160-160v520Zm60-92V258q56 21 88 74t32 104q0 51-35 101t-85 67Zm0 142v-62q70-25 125-90t55-158q0-93-55-158t-125-90v-62q102 27 171 112.5T920 436q0 112-69 197.5T680 746Z\"/></svg>', 0, 'voiceover', '2023-06-30 19:13:33', '2023-06-30 19:13:33', NULL, 0, 0, '#DEFF81', 'voiceover');
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `script_version` double NOT NULL DEFAULT '1.61',
  ...
  `gcs_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gcs_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `free_plan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0,0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2', NULL, '0', NULL, NULL, 'https://api.stripe.com', '0', NULL, NULL, 'MagicAI', 'https://liquid-themes.com', NULL, '0', NULL, 'magicAI-logo.svg', NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, 1, 'United States', NULL, NULL, NULL, NULL, NULL, NULL, 'TLS', NULL, '2023-06-30 19:13:33', '2023-06-30 19:13:33', 'assets/img/logo/magicAI-logo.svg', NULL, 'gpt-3.5-turbo', 'en-US', 'professional', '0.75', '300', '200', '10', '10', 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, 1.61, 'magicAI-logo-Collapsed.png', 'assets/img/logo/magicAI-logo-Collapsed.png', 'active', 'magicAI-logo-dark.svg', NULL, NULL, 'magicAI-logo-collapsed-dark.svg', NULL, NULL, NULL, NULL, NULL, NULL, 'assets/img/logo/magicAI-logo-dark.svg', NULL, NULL, 'assets/img/logo/magicAI-logo-collapsed-dark.svg', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, 'low', 0, 'Accept', 'This website uses cookies to improve your web experience.', NULL, 0, 0, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, '0,0');
...
(1, 'Admin', 'Admin', 'admin@admin.com', '5555555555', 'admin', '$2y$10$XptdAOeFTxl7Yx2KmyfEluWY9Im6wpMIHoJ9V5yB96DgQgTafzzs6', 'assets/img/auth/default-avatar.png', NULL, NULL, NULL, NULL, NULL, 1, 3000000, 3000000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-06-30 19:13:33', '2023-06-30 19:13:33', NULL, NULL, NULL, NULL, 'P60NPGHAAFGD', '0', NULL, NULL, NULL, 0, NULL, NULL, NULL);
