	...
	class="
	  ...
	  dark:bg-zinc-800">
		...
		<ul class="p-0 m-0 list-none">
			...
			@endif
			<li class="border-solid border-b border-t-0 border-r-0 border-l-0 !border-black !border-opacity-5 last:border-0 dark:!border-white dark:!border-opacity-5">
				<a class="block !px-4 !py-2 relative text-inherit hover:no-underline before:absolute before:inset-0 before:text-current before:bg-current before:opacity-0 before:transition-opacity hover:before:opacity-5 [&.active]:before:opacity-5 {{ route('dashboard.adsense.addOrUpdate') == url()->current() ? 'active' : '' }}" href="{{route('dashboard.adsense.addOrUpdate')}}">{{__('New Adsense')}}</a>
			</li>
